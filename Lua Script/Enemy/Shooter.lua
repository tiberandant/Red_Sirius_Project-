...
local function createProjectile(targetPosition)
	...
	projectile.Size = Vector3.new(0.3, 0.3, 0.3)  -- 프로젝타일 크기
	...
	projectile.Touched:Connect(function(hit)
		...
		if targetHumanoid and (targetHumanoid.RootPart.Position - hit.Position).Magnitude <= 20 then  -- 피격 범위 확대
...
local function attack()
	...
	-- 목표 지점을 HumanoidRootPart로 수정하여 중심 지점 지정
	...
	maid.humanoid.WalkSpeed = ATTACK_MIN_WALKSPEED  -- 공격 후 이동 속도 복귀
